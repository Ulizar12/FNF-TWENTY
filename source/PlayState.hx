...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'examplestage':
				{
						defaultCamZoom = 0.9;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(-500, -330).loadGraphic(Paths.image('factory'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
						...
						defaultCamZoom = 0.9;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(-500,-100).loadGraphic(Paths.image('shadow'));
						bg.antialiasing = true;
			...
			case 'white':
				{
						defaultCamZoom = 1.2;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(5, -50).loadGraphic(Paths.image('white'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
		...
		{
		case 'coldsteel':
		healthBar.createFilledBar(0xFFb414c9, 0xFF007BFF);
		}
		// healthBar
		add(healthBar);
